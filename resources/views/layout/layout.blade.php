                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                    <i class="side-menu__icon fa fa-dropbox"></i>
                                    <span class="side-menu__label">SIPMEN</span><i
                                        class="angle fa fa-angle-right"></i></a>
                                <ul class="slide-menu">
                                    <li class="side-menu-label1"><a href="javascript:void(0)">Submenus</a></li>
                                    {{-- <li><a href="{{ url('p_koseka') }}" class="slide-item">Penerimaan Koseka</a>
                                    </li> --}}
                                    <li><a href="{{ url('p_kabkot') }}" class="slide-item">Penerimaan
                                            Kabupaten/Kota</a>
                                    </li>
                                    {{-- <li><a href="{{ url('p_provinsi') }}" class="slide-item">Penerimaan Provinsi</a>
                                    </li> --}}
                                    <li><a href="{{ url('box_besar') }}" class="slide-item">Box Besar</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                    ...
                                    <span class="side-menu__label">Master Data</span><i
                                        class="angle fa fa-angle-right"></i></a>
                                <ul class="slide-menu">
                                    <li class="side-menu-label1"><a href="javascript:void(0)">Submenus</a></li>
